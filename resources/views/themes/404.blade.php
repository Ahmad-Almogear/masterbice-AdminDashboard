...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.15.4/cssall.css"/>
        <link href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.4.1/font/bootstrap-icons.css" rel="stylesheet">

        <!-- Libraries Stylesheet -->
        <link href="{{ asset ('assetsTheme/libanimate/animate.min.css') }}" rel="stylesheet">
        <link href="{{ asset ('assetsTheme/liblightbox/csslightbox.min.css') }}" rel="stylesheet">
        <link href="{{ asset ('assetsTheme/libowlcarousel/assets/owl.carousel.min.css') }}" rel="stylesheet">
    ...
    <script src="{{ asset ('assetsTheme/libwow/wow.min.js') }}"></script>
    <script src="{{ asset ('assetsTheme/libeasing/easing.min.js') }}"></script>
    <script src="{{ asset ('assetsTheme/libwaypoints/waypoints.min.js') }}"></script>
    <script src="{{ asset ('assetsTheme/liblightbox/js/lightbox.min.js') }}"></script>
    <script src="{{ asset ('assetsTheme/libowlcarousel/owl.carousel.min.js') }}"></script>
