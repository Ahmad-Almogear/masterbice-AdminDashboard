...
@section('content')
                                ...
                                <table id="DataList"
                                    ...
                                    <tbody>
                                        ...
                                        <td>
                                            ...
                                            <td class="user_id">{{ $program->title }}</td>
                                            <td>{{ $program->price }}</td>
                                            <td>{{ $program->description }}</td>
                                            <td>{{ $program->seats }}</td>
                                            <td>{{ $program->hours_count }}</td>
                                            <td>{{ $program->start_date }}</td>
                                            <td>{{ $program->lectures_count }}</td>
                                            <td>{{ $program->teacher_name }}</td>
                                            <td>{{ $program->teacher_specialty }}</td>
                                            ...
                                            <td class="text-end">
                                                <div class="actions">
                                                    ...
                                                    <a class="btn btn-sm bg-danger-light teacher_delete"
                                                        data-bs-toggle="modal" data-bs-target="#ProgramDelete">
    ...
    <div class="modal custom-modal fade" id="ProgramDelete" role="dialog">
