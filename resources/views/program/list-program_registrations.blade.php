                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table id="DataList" class="table border-0 star-student table-hover table-center mb-0 datatable table-striped">
                                ...
                                <tbody>
                                    @foreach($registrationsProgram as $registration)                                    {{-- <tr>
                                        <td>
                                            <div class="form-check check-tables">
                                        ...
                                        <td>{{ $loop->iteration }}</td>
                                            ...
                                            <td>{{ $registration->children_count }}</td>
                                            <td>{{ $registration->child_name }}</td>
                                            <td>{{ $registration->program->title }}</td>
                                            <td>{{($registration->program->start_date)}}</td>
                                        <td class="text-end">
                                            <div class="actions">
                                                <a href="{{ url('teacher/edit/'.$registration->user_id) }}" class="btn btn-sm bg-danger-light">
