                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="number" class="form-control  @error('seats') is-invalid @enderror" name="seats" placeholder="seats" value="{{ old('seats') }}">
                                        @error('seats')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="number" class="form-control  @error('lectures count') is-invalid @enderror" name="lectures_count" placeholder="lectures Count" value="{{ old('lectures_count') }}">
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="number" class="form-control  @error('hours Count') is-invalid @enderror" name="hours_count" placeholder="hours Count" value="{{ old('hours_count') }}">
                                        @error('hours Count')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="file" class="form-control  @error('seats') is-invalid @enderror" name="program_image" placeholder="program image" value="{{ old('program_image') }}">
                                        @error('program_image')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="text" class="form-control @error('teacher_name') is-invalid @enderror" name="teacher_name" placeholder="Enter teacher Name" value="{{ old('teacher_name') }}">
                                        @error('teacher_name')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="text" class="form-control @error('teacher Specialty') is-invalid @enderror" name="teacher_specialty" placeholder="Enter teacher Specialty" value="{{ old('teacher_specialty') }}">
                                ...
                                <div class="col-12 col-sm-4">
                                    <div class="form-group local-forms">
                                        ...
                                        <input type="file" class="form-control @error('teacher Image') is-invalid @enderror" name="teacher_image" placeholder="Enter teacher Image" value="{{ old('teacher_image') }}">
                                        @error('teacher Image')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
